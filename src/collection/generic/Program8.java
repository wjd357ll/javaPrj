...
public class Program8 {
	...
	private static void outputExam(ArrayList<Exam> list) {
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			// 위와 같이 범용적인 컬렉션을 사용하는 것에 대한 단점은 
			// 범용적인 자료형으로 컬렉션에서 꺼내오기 때문에 내가 원하는 자료형으로 형변환을 해서 사용해야 한다는 점이다.
	...
	private static void inputExam(ArrayList<Exam> list) { 
		...
		list.add(exam); // exam을 ArrayList의 add 함수 안으로 넘겨준다.
